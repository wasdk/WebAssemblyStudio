...
define("vs/editor/editor.main.nls", {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"Do not remember suggestions and always select the first.",
		"Select recent suggestions unless further typing selects one, e.g. `console.| -> console.log`",
	...
	"vs/editor/contrib/format/formatActions": [
		...
		"Sorry, but there is no formatter for '{0}'-files installed.",
		"Format Document",
		"Format Selection"
	],
